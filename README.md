...
2. `config/plugin/template/ios/sandboxRNSpoiler/PersonalAccount.xcconfig.template` を `config/plugin/template/ios/sandboxRNSpoiler/PersonalAccount.xcconfig` としてコピーしてください。
