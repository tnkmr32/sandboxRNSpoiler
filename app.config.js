...
module.exports = ({config}) => {
  const defaultAppConfig = {
    ...
    ios: {
      bundleIdentifier: 'org.name.sandboxRNSpoiler',
      supportsTablet: true,
    },
    disabledPlugins: [
...
`,
      ...
      [
        appPlugin.withIosSetCredentials,
        {
          ...
          bundleIdentifier: 'personal.org.name.sandboxRNSpoiler.${PERSONAL_IDENTIFIER}',
        },
      ],
    ],
    updates: {
